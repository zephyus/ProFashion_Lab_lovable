...
export const Route = createFileRoute("/_app/")({
  head: () => ({
    meta: [
      { title: "自我探索遊戲區｜職涯探索" },
      { name: "description", content: "結合 MBTI 與 UCAN 的職涯探索測驗，幫助學生找到方向。" },
    ],
  }),
  ...
  return (
    <div className="px-5 pt-12">
      <header className="mb-6">
        ...
        <h1 className="mt-3 text-3xl font-bold tracking-tight">自我探索遊戲區</h1>
      ...
      {done && (() => {
        ...
        return (
          <div className="space-y-4">
            ...
            <button onClick={reset} className="flex w-full items-center justify-center gap-2 rounded-2xl border border-border bg-card py-3 text-sm font-medium text-foreground transition-colors hover:bg-primary-soft">
