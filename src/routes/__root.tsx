...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "讓每個生命都能在最適合的位置上發光。不再有任何一個職業被誤解，不再有任何一個夢想因資訊不足而熄滅。" },
      { property: "og:title", content: "ProFashion Lab 職感實驗室" },
      { property: "og:description", content: "讓每個生命都能在最適合的位置上發光。不再有任何一個職業被誤解，不再有任何一個夢想因資訊不足而熄滅。" },
